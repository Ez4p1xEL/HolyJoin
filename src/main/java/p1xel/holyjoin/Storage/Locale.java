...
public class Locale {
    ...
    public static void createFile() {
        ...
        for (String l : lang) {
            File file = new File(HolyJoin.getInstance().getDataFolder(), l + ".yml");
            if (!file.exists()) {
                HolyJoin.getInstance().saveResource(l + ".yml", false);
            }
        }
    }

    public static FileConfiguration get() {
        File file = new File(HolyJoin.getInstance().getDataFolder(), Config.getLanguage() + ".yml");
